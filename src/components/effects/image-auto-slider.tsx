...
export function ImageAutoSlider() {
    return (
        <div className="w-full overflow-hidden my-16 md:my-24">
            <div className="scroll-container w-full">
                <div className="infinite-scroll flex gap-6 w-max">
                    {duplicatedImages.map((src, index) => (
                        <div
                            key={index}
                            className="image-item flex-shrink-0 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-xl overflow-hidden shadow-2xl relative"
                        >
                            <Image
                                src={src}
